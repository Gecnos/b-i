...
<body>
    ...
    <div class="main-content">
        <div class="content-header">
            ...
            <a href="form_partenaire.php?action=add" class="add-new-btn">Ajouter un partenaire</a>
        </div>
        ...
        <table class="content-table">
            ...
            <tbody>
                <?php if (empty($partenaires)): ?>
                    <tr>
                        <td colspan="5" style="text-align: center;">Aucun partenaire trouvé.</td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($partenaires as $partenaire): ?>
                        <tr>
                            <td><img src="../<?php echo htmlspecialchars($partenaire['logo_url']); ?>" alt="Logo <?php echo htmlspecialchars($partenaire['nom']); ?>" style="max-width: 100px; max-height: 50px;"></td>
                            <td><?php echo htmlspecialchars($partenaire['nom']); ?></td>
                            <td><?php echo htmlspecialchars($partenaire['type_partenariat']); ?></td>
                            <td><a href="<?php echo htmlspecialchars($partenaire['site_web_url']); ?>" target="_blank"><?php echo htmlspecialchars($partenaire['site_web_url']); ?></a></td>
                            <td class="actions">
                                <a href="form_partenaire.php?action=edit&id=<?php echo $partenaire['id_partenaire']; ?>" class="edit">Modifier</a>
                                <a href="action_partenaire.php?action=delete&id=<?php echo $partenaire['id_partenaire']; ?>" class="delete" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce partenaire ?');">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
