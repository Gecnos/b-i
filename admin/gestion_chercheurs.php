...
// Fetch all chercheurs
$stmt = $pdd->query('SELECT * FROM chercheurs ORDER BY nom ASC, prenom ASC');
$chercheurs = $stmt->fetchAll(PDO::FETCH_ASSOC);

$pageTitle = "Gestion des Chercheurs";
...
<body>
    ...
    <div class="main-content">
        <div class="content-header">
            ...
            <a href="form_chercheur.php?action=add" class="add-new-btn">Ajouter un chercheur</a>
        </div>
        ...
        <table class="content-table">
            ...
            <tbody>
                <?php if (empty($chercheurs)): ?>
                    <tr>
                        <td colspan="5" style="text-align: center;">Aucun chercheur trouvé.</td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($chercheurs as $chercheur): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($chercheur['nom']); ?></td>
                            <td><?php echo htmlspecialchars($chercheur['prenom']); ?></td>
                            <td><?php echo htmlspecialchars($chercheur['titre']); ?></td>
                            <td><?php echo htmlspecialchars($chercheur['email']); ?></td>
                            <td class="actions">
                                <a href="form_chercheur.php?action=edit&id=<?php echo $chercheur['id_chercheur']; ?>" class="edit">Modifier</a>
                                <a href="action_chercheur.php?action=delete&id=<?php echo $chercheur['id_chercheur']; ?>" class="delete" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce chercheur ?');">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
